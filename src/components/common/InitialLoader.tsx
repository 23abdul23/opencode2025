...
export default function InitialLoader({
  ...
  const animationData = variant === 'trophy' ? trophyAnimation : seoRankingAnimation;
  const message =
    ...
    >
      ...
      >
        <Box w={{ base: '200px', md: '260px' }}>
          <Lottie animationData={animationData} loop={false} onComplete={onComplete} />
        </Box>
        <Text fontSize={{ base: 'md', md: 'lg' }} fontWeight="600" opacity={0.85}>
          {message}
        </Text>
      </Flex>
    </Box>
